...
def gen_pnet_train_data(store_pnet_data_dir,anno_file,prefix):
    '''
    :param store_pnet_data_dir: store the generated training dataset used for PNET(inputsize =12)
    :param anno_file:annotations of the generated training dataset used for PNET
    :param prefix:root path of whole training dataset
    :return:
    '''
    ...
    for annotation in annotations:
        ...
        while neg_num < 50:
            ...
            Iou = IoU(crop_box, boxes) #judge the iou if is ok
            if np.max(Iou) < 0.3:
