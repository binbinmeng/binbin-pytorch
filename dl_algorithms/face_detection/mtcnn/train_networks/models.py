...
class PNet(nn.Module):
    ...
    def __init__(self, is_train=False, use_cuda=True):
        ...
        self.pre_layer = nn.Sequential(
            nn.Conv2d(3, 10, kernel_size=(3, 3), stride=(1, 1), padding=(0, 0), groups=1),  # conv1
            #nn.Conv2d(3, 10, kernel_size=(1, 1), stride=(1, 1), padding=(0, 0)),
            nn.PReLU(),  # PReLU1
            nn.MaxPool2d(kernel_size=(2, 2), stride=(2, 2), padding=(0, 0)),  # pool1
            nn.Conv2d(10, 16, kernel_size=(3, 3), stride=(1, 1), padding=(0, 0), groups=1),  # conv2
            #nn.Conv2d(10, 16, kernel_size=(1, 1), stride=(1, 1), padding=(0, 0)),
            nn.PReLU(),  # PReLU2
            nn.Conv2d(16, 16, kernel_size=(3, 3), stride=(1, 1), padding=(0, 0), groups=16),  # conv3
            nn.Conv2d(16, 32, kernel_size=(1, 1), stride=(1, 1), padding=(0, 0)),
            nn.PReLU()  # PReLU3
        )
        # detection
