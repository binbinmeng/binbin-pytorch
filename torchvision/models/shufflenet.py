...
def shufflenet_1_0(groups, **kwargs):
    if groups == 1:
        return shuffleNetG1(**kwargs)
    elif groups == 2:
        return shuffleNetG2(**kwargs)
    elif groups == 3:
        return shuffleNetG3(**kwargs)
    elif groups == 4:
        return shuffleNetG4(**kwargs)
    elif groups == 8:
        return shuffleNetG8(**kwargs)
